...
class GetAllUsers(APIView):
    ...
    def get(self, request):
        ...
        for user in serializer.data:
            user["profile_image"] = urljoin(base_url, user["profile_image"]) 
...
class UserProfileView(APIView):
    ...
    def get(self, request):
            ...
            if user_profile:
                serializer = UserProfile_Serializer(user_profile)
                data = serializer.data.copy()  # make mutable copy
                if user_profile.profile_image:
                    data["profile_image"] = urljoin(base_url, data["profile_image"])
